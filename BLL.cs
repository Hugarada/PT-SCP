...
namespace BusinessLogicLayer
{
    public class BLL
    {
        ...
        public class Article
        {
            ...
            static public int insertArticle(int IDing, string Name, string Description, string Writter, string Site_Area, string Type, int LVL)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlparams = new SqlParameter[]
                    {
                        new SqlParameter("@IDing", IDing),
                        new SqlParameter("@Name", Name),
                ...
                return dal.executarNonQuery("INSERT into Article (IDing, Name, Description, Writter, Approved, Type, Site_Area, LVL) VALUES (@IDing, @Name, @Description, @Writter, @Approved, @Type, @Site_Area, @LVL)", sqlparams);
            }

            static public int updateArticle(string Name, string Description, string Type, string Class, int LVL, string SITE_AREA, string oldName, string Approved)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlparams = new SqlParameter[]
                    {
            ...
            static public DataTable getSCPbyLVL(int LVL)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlparams = new SqlParameter[]
                {
                ...
                return dal.executarReader("SELECT * FROM Article WHERE LVL<=@LVL", sqlparams);
            }

            static public DataTable getTaleByLVL(int LVL)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlparams = new SqlParameter[]
                {
