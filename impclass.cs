...
namespace SCP
{
    class impclass
    {
        ...
        public async void updated(string Email, string Name, string Password, string Roll, string Level, string Group, string SITE_AREA, string CAssignment, string oldpassword)
        {
            try
            {
                ...
                if (Password != "" && oldpassword != "")
                {
                    ...
                    if (dt.Rows.Count == 1)
                    {
                        BLL.Employees.alterarPerfil(Email, Password, Name, Roll, Level, Group, SITE_AREA, CAssignment);
                    }
                }
                else
                {
                    BLL.Employees.alterarPerfilnonpass(Email, Name, Roll, Level, Group, SITE_AREA, CAssignment);
                }
        ...
        public async void logging(string email, string pass)
        {
            admin = false;
            act = 1;
